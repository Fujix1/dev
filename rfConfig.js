...
const softlistTitleJ = [
  ...
  { from: "Sega Mega Drive/Genesis cartridges", to: "セガメガドライブ/Genesisカセット" },
  { from: "Sega Master System cartridges", to: "セガマスターシステムカセット" },
  { from: "Sega SG-1000 and SG-1000 MarkII cartridges", to: "セガSG-1000/SG-1000 Mark IIカセット" },
  { from: "Sega Computer 3000 cartridges", to: "セガSC-3000カセット" },
  { from: "Sega Computer 3000 cassettes", to: "セガSC-3000テープ" },
  { from: "Sega Beena cartridges", to: "セガビーナカセット" },
  { from: "Sega Pico cartridges", to: "セガピコカセット" },
  { from: "Sega Visual Memory Unit quickloads", to: "セガビジュアルメモリユニットクイックロード" },
  { from: "Sega Mega CD (Japan) CD-ROMs", to: "セガメガCD (日本版) CD-ROM" },
  { from: "Sega Mega CD (Europe) CD-ROMs", to: "セガメガCD (欧州版) CD-ROM" },
  { from: "Sega CD CD-ROMs", to: "セガCD (US版) CD-ROM" },
  { from: "Sega CD CD-ROMs", to: "セガCD (US版) CD-ROM" },
  ...
  { from: "hard disk images", to: "ハードディスク" },
  { from: "original disk images", to: "オリジナルディスク" },
  { from: "cleanly cracked disks", to: "クリーンクラックディスク" },
  { from: "hard disks", to: "ハードディスク" },
  { from: "high density disk images", to: "高密度ディスク" },
