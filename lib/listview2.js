...
class ListView2 {
  constructor(args) {
    ...
    this.columnClick = args.columnClick ? args.columnClick : true;
  ...
  async init() {
    ...
    this.itemCount = this.dataset.filteredLength;
  ...
  onListKeydown(e) {
    ...
    switch (e.code) {
      ...
      case "ArrowUp":
      case "Numpad8":
        if (this._itemCount > 1 && this.dataIndex != -1) {
        }
