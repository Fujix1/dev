...
class Dats {
  ...
  static async showInfo(zipName) {
    ...
    if (zipName === "") {
      ...
      document.getElementById("editDescriptionJ").setAttribute("type", "hidden");
      document.getElementById("editDescriptionJ").setAttribute("type", "text");
      document.getElementById("editKana").value = row.kana;
      document.getElementById("editKana").setAttribute("type", "hidden");
      document.getElementById("editKana").setAttribute("type", "text");
